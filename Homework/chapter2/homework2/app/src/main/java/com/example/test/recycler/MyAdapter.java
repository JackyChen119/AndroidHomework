...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    private List<TestDemo> mDataset = new ArrayList<>();
    ...
    public interface IOnItemClickListener {
        void onItemCLick(int position, TestDemo data);
        void onItemLongCLick(int position, TestDemo data);
    }

    public MyAdapter(List<TestDemo> myDataset) {
    ...
    public void addData(int position, TestDemo data) {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void onBind(int position, TestDemo data) {
